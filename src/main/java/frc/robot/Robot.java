...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    if (m_robotContainer.updateBackVisionPose != null){
      m_robotContainer.updateBackVisionPose.run();
      }
  
      if (m_robotContainer.updateFrontVisionPose != null){
      m_robotContainer.updateFrontVisionPose.run();
      }
  }
