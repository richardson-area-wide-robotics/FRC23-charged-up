...
public class BottomMidScore2Park extends AutonBase {
    ...
    List<PathPlannerTrajectory> pathGroup = PathPlanner.loadPathGroup("Bottom-Score-2-Mid-Park", new PathConstraints(1.5, 3.5), new PathConstraints(2.0, 4.0));
    ...
    addCommandsWithLog("Bottom Score 2 Mid Park",
