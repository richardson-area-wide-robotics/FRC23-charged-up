...
public class TopLink extends AutonBase {
    ...
    List<PathPlannerTrajectory> topLink = AutonUtil.loadTrajectoryGroup("Top-Link", new PathConstraints(3.0, 4.5), new PathConstraints(3.0, 5.0));
