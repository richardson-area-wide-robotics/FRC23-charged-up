...
import frc.lib.swerve.MAXModule;
import frc.lib.util.SwerveModuleConstants;
import frc.robot.Constants;

public class MAXSwerveModule implements MAXModule {
  ...
  public void drivingConfig(
      CANSparkMax driveMotor, SparkMaxPIDController drivingPidController, RelativeEncoder enc) {
  ...
  public void turningConfig(
      CANSparkMax turnMotor, SparkMaxPIDController turningPidController, AbsoluteEncoder enc) {
    // Factory reset, so we get the SPARKS MAX to a known state before configuring
    // them. This is useful in case a SPARK MAX is swapped out.
