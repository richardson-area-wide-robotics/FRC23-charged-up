...
public class Intake extends SubsystemBase {
  ...
  public Intake() {
    ...
    intakePIDController.setOutputRange(Constants.Intake.kMinOutput, Constants.Intake.kMaxOutput);
  ...
  public void toggleIntake() {
    ...
    intakePIDController.setReference(
        intakePositions.get(currentIntakePosition), CANSparkMax.ControlType.kPosition);
  }
}
